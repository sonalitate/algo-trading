...
data=pd.read_csv("C:\\Users\\s\\Desktop\\CaseStudy3\\CUMMINS.csv")
data
...
for index in range(0,719):
    if(closingValueLists[index]<lowerBBValues[index]):
...
print("Profit or Loss made by the company is....",(noOfShares*closingValueLists[718])-1000000)
print(noOfShares)
